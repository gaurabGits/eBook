    ...
    <>
      ...
      <style>{`
        @keyframes walk {
          ...
          15%  { transform: translateY(-6px) rotate(2deg) scaleX(1); }
          30%  { transform: translateY(0) rotate(-4deg) scaleX(1); }
          45%  { transform: translateY(-6px) rotate(2deg) scaleX(1); }
          60%  { transform: translateY(0) rotate(-4deg) scaleX(1); }
          75%  { transform: translateY(-6px) rotate(2deg) scaleX(1); }
          100% { transform: translateY(0) rotate(-4deg) scaleX(1); }
        }
        .animate-walk {
          animation: walk 0.7s ease-in-out infinite;
                  ...
                  <form onSubmit={handleSubmit} className="space-y-0">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <a
                          href="#"
                          className="text-xs text-indigo-600 dark:text-indigo-400 hover:underline transition-all duration-200"
                        >
                          Forgot?
                        </a>
                      </div>
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 ease-in-out
                      ...
                      >
                        ...
                        {/* Walking icon – animate when loading */}
                        <span
                          className={`text-xl ${loading ? "animate-walk" : ""}`}
                        >
